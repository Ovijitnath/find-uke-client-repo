...
const AddProduct = () => {
    ...
    return (
        <div className='my-5'>
            ...
            <div className='h-[900px] flex justify-center items-center p-5'>
                <form onSubmit={handleSubmit(handleAddProduct)}>
                    ...
                    <div className="form-control w-full max-w-xs">
                        ...
                        <select {...register("category", {
                            ...
                            <option value={'6382695b0ab2ffa40d6aa68b'}>Concert</option>
                            <option value={'6382695b0ab2ffa40d6aa68a'}>Soprano</option>
                            <option value={'6382695b0ab2ffa40d6aa68c'}>Tenor</option>
                        </select>
                    </div>
                    <div className="form-control w-full max-w-xs">
