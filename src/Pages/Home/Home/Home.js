            ...
            <section className='pb-10  md:pb-15 lg:pb-20'>
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full  md:px-24 lg:px-8 lg:py-20 bg-slate-100">
                    ...
                    <div className="flex items-center sm:justify-center">
                        <Link
                            to="/"
                            className="inline-flex items-center justify-center h-12 px-6 mr-6 font-medium tracking-wide  transition duration-200 rounded shadow-md bg:deep-purple-accent-400 hover:bg-purple-accent-700 focus:shadow-outline focus:outline-none"
                        >
                            Sign up
                        </Link>
                        <Link
