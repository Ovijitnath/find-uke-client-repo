...
const ErrorPage = () => {
    return (
        <div>
            ...
            <div className="h-screen w-screen bg-amber-50 flex items-center">
                <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
                    ...
                    <div className="max-w-lg">
                        <img src="https://carbon-media.accelerator.net/0000000exsu/bYHWWqidLr6dTcqgHPCIhh;original.gif" alt="" />
                    </div>
