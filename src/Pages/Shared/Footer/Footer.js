...
const Footer = () => {
    return (
        <div>
            <hr />
            <div className="px-4 py-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-sm text-gray-500">
                            Have a question? Contact us.  I am here to help. CONTACT THE NEWSROOM ... Get in touch with the Social Media!
                        </p>
                    </div>
                </div>
