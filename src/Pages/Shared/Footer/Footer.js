...
const Footer = () => {
    return (
        <div>
            <hr />
            <div className="px-4 py-4 pt-16 mx-auto sm:max-w-xl md:max-w-full  md:px-24 lg:px-8">
                <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                    <div className="sm:col-span-2">
                        ...
                        >
                            ...
                            <span className="ml-2 px-2 text-xl font-bold tracking-wide text-gray-800">
                                FindUke
                            </span>
                    ...
                    <div>
                        ...
                        <p className="mt-4 text-sm text-gray-500">
                            Have a question? Contact us.  We are here to help. CONTACT THE NEWSROOM ... Get in touch with the Social Media!
                        </p>
                    </div>
                </div>
                <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
                    <p className="text-sm text-gray-600">
                        © Copyright 2022 Find Uke Inc. All rights reserved.
                    </p>
